...
class Order(models.Model):
    ...
    is_option_order = models.BooleanField(default=False, blank=False, null=False)
    option_type = models.CharField(max_length=1, choices=OPTION_TYPES, blank=False, null=True)
    option_strike = models.IntegerField(blank=False, null=True)
    option_num_contracts = models.IntegerField(blank=False, null=True)
    option_expiration = models.DateField(blank=False, null=True)

    def verifyOptionOrder() -> bool:
        if self.is_option_order:
            return (self.option_type != None) and
                   (self.option_strike != None) and
                   (self.option_num_contracts != None and self.option_num_contracts > 0) and
...
class Option(models.Model):
    ...
    strikePrice = models.IntegerField(blank=False, null=False)
    numberOfContracts = models.IntegerField(default=1, blank=False, null=False)
